    ...
    <div className="shell max-w-3xl py-10 lg:py-14">
      <div className="flex items-start justify-between gap-4 sm:gap-6">
        <div className="min-w-0">
          <TodayDate
            initial={dateLabel}
            trusted={dateIsTrusted}
            className="text-[0.95rem] font-medium text-mauve"
          />
          ...
          <p className="mt-2 text-[1.02rem] text-mauve">
            {firstName ? `${firstName}, here` : "Here"}&rsquo;s what needs your attention today.
          </p>
        </div>
